...
let UserService = class UserService {
    ...
    getUsers() {
        //get users with id
        this.users = this.usersCollection.snapshotChanges().pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["map"])(changes => {
    ...
    getUser(id) {
        ...
        this.user = this.userDoc.snapshotChanges().pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["map"])(action => {
